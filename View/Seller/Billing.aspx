<%@ Page Title="" Language="C#" MasterPageFile="~/View/Seller/SellerMaster.Master" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="OnlineGrocery.View.Seller.Billing" %>
        ...
        <div class="row">
            <div class="col-mid-5">
                <div class="row">
                    ...
                    <div class="col">
                        <img src="../../Asset/Images/check_dollar_icon.jpg" height="130px" width="130px" style="bottom: 5%" /><br />
                        <br />
            ...
            <div class="col-mid-7">
                ...
                <div class="row">
                    <asp:GridView ID="dtgBill" runat="server" class="table" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
